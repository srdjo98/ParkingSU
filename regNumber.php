...
$zona1 = $zons->getZonaByRegisterNumber('zona1',$zonaVal,$register_number);
$zona2 = $zons->getZonaByRegisterNumber('zona2',$zonaVal,$register_number);
$zona3 = $zons->getZonaByRegisterNumber('zona3',$zonaVal,$register_number);
$zona4 = $zons->getZonaByRegisterNumber('zona4',$zonaVal,$register_number);
