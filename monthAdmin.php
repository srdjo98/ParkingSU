...
if(!empty($month) && $month > 0){
    ...
    $zona1M = $zons->getZona('zona1',$month,$zonaVal);
    $zona2M = $zons->getZona('zona2',$month,$zonaVal);
    $zona3M = $zons->getZona('zona3',$month,$zonaVal);
    $zona4M = $zons->getZona('zona4',$month,$zonaVal);
